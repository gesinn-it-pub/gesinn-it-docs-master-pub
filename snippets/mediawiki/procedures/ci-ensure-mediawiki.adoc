...
NOTE: Unit and integration suites must run as *separate PHP processes*.
...
runners. Replace `<extension-id>` with the lowercase extension identifier
used in `phpunit.xml.dist` (e.g. `page-forms`).
