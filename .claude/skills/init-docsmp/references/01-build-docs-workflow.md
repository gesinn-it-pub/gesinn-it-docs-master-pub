# build-docs.yml — Template

Substitute `{PROJECT_TYPE}` and the scope list before writing this file.
...
jobs:
  ...
  build:
    ...
    steps:
      ...
      - name: Remove intermediate AGENTS files
        run: |
          rm -f AGENTS.adoc AGENTS.xml
      ...
      - name: Build skills
        run: |
          ...
          ATTR_ARGS=()
          grep -q ':phan:' docs/attributes.adoc && ATTR_ARGS+=(--attribute phan)
