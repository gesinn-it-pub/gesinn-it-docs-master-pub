...
include::../snippets/conventional-commits.adoc[]

include::../snippets/note-contains-submodule.adoc[]
...
include::../snippets/test-first-approach.adoc[]
...
include::../snippets/docker-compose-ci-pre-commit-validation-gate.adoc[]

---

*Step 5: Commit your changes*

include::../sections/conventional-commits-policy.adoc[]
